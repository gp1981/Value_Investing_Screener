...
# 02 - Inputs required ----
last_business_date <-as.Date("2025-01-10") # update here the last business date 
period <- "quarter"
period_limit <- 48
...
DF_last_FQ_GIG_Performance  <- IGVI_Screener_Performance(DF_last_FQ_Output_GIG_Full_List_Greenblatt)
