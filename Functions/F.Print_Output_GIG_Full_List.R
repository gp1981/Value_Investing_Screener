...
# Output: DF_last_FQ_GIG_Output_Full_List - Dataframe with data categorized based on the Greenblatt ranking and other metrics


Print_Output_GIG_Full_List <- function(DF_last_FQ_G) {
  
  # 01 - Data Preparation ---------------------------------------------------
  
  # Create a new dataframe for the output
  DF_last_FQ_GIG_Output_Full_List <- DF_last_FQ_G
  
  # Assign output categories based on specific conditions
  DF_last_FQ_GIG_Output_Full_List <- DF_last_FQ_GIG_Output_Full_List %>% 
  ...
  return(DF_last_FQ_GIG_Output_Full_List)
}

# Example usage:
# df_output <- IGVI_Print_Output_GIG_Full_List(df_last_fq_g)
